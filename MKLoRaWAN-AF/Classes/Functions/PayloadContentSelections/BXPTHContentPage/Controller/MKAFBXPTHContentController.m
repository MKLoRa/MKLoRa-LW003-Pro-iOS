...
@interface MKAFBXPTHContentController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAFBXPTHContentModel *dataModel;

@end

@implementation MKAFBXPTHContentController

- (void)dealloc {
    NSLog(@"MKAFBXPTHContentController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AF", @"MKAFBXPTHContentController", @"af_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAFBXPTHContentModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAFBXPTHContentModel alloc] init];
    }
    return _dataModel;
}
