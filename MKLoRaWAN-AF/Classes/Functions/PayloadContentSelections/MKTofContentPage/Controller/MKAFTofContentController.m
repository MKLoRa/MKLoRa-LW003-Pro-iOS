...
@interface MKAFTofContentController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAFTofContentModel *dataModel;

@end

@implementation MKAFTofContentController

- (void)dealloc {
    NSLog(@"MKAFTofContentController销毁");
}
...
- (void)loadSection1Datas {
    MKTextSwitchCellModel *cellModel1 = [[MKTextSwitchCellModel alloc] init];
    cellModel1.index = 3;
    cellModel1.msg = @"MFG Code";
    cellModel1.isOn = self.dataModel.mfg;
    [self.section1List addObject:cellModel1];
    
    MKTextSwitchCellModel *cellModel2 = [[MKTextSwitchCellModel alloc] init];
    cellModel2.index = 4;
    cellModel2.msg = @"Beacon Code";
    cellModel2.isOn = self.dataModel.beacon;
    [self.section1List addObject:cellModel2];
    
    MKTextSwitchCellModel *cellModel3 = [[MKTextSwitchCellModel alloc] init];
    cellModel3.index = 5;
    cellModel3.msg = @"Battery Voltage";
    cellModel3.isOn = self.dataModel.battery;
    [self.section1List addObject:cellModel3];
    
    MKTextSwitchCellModel *cellModel4 = [[MKTextSwitchCellModel alloc] init];
    cellModel4.index = 6;
    cellModel4.msg = @"Ranging Distance";
    cellModel4.isOn = self.dataModel.ranging;
    [self.section1List addObject:cellModel4];
    
    MKTextSwitchCellModel *cellModel5 = [[MKTextSwitchCellModel alloc] init];
    cellModel5.index = 7;
    cellModel5.msg = @"User Data";
    cellModel5.isOn = self.dataModel.user;
    [self.section1List addObject:cellModel5];
    
    MKTextSwitchCellModel *cellModel6 = [[MKTextSwitchCellModel alloc] init];
    cellModel6.index = 8;
    cellModel6.msg = @"Sub Type";
    cellModel6.isOn = self.dataModel.subType;
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"MK-TOF Content";
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AF", @"MKAFTofContentController", @"af_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAFTofContentModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAFTofContentModel alloc] init];
    }
    return _dataModel;
}
