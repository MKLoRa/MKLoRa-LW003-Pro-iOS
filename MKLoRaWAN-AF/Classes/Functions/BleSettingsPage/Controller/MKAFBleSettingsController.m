...
@interface MKAFBleSettingsController ()<UITableViewDelegate,
UITableViewDataSource,
MKTextFieldCellDelegate,
mk_textSwitchCellDelegate,
MKAFBroadcastTxPowerCellDelegate>
...
@implementation MKAFBleSettingsController

- (void)dealloc {
    NSLog(@"MKAFBleSettingsController销毁");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        MKAFBroadcastTxPowerCell *cell = [MKAFBroadcastTxPowerCell initCellWithTableView:tableView];
...
#pragma mark - MKAFBroadcastTxPowerCellDelegate
/*
...
- (void)af_txPowerValueChanged:(NSInteger)txPower {
    ...
    MKAFBroadcastTxPowerCellModel *cellModel = self.section1List[0];
...
- (void)configPassword{
    ...
    [alertView showAlertWithTitle:@"Change Password" message:msg notificationName:@"mk_af_needDismissAlert"];
}
...
- (void)setPasswordToDevice{
    ...
    [[MKHudManager share] showHUDWithTitle:@"Setting..."
                                     inView:self.view
                              isPenetration:NO];
    [MKAFInterface af_configPassword:password sucBlock:^{
        [[MKHudManager share] hide];
        [self.view showCentralToast:@"Success"];
    } failedBlock:^(NSError * _Nonnull error) {
        [[MKHudManager share] hide];
...
- (void)loadSection1Datas {
    MKAFBroadcastTxPowerCellModel *cellModel = [[MKAFBroadcastTxPowerCellModel alloc] init];
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AF", @"MKAFBleSettingsController", @"af_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAFBleSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAFBleSettingsModel alloc] init];
    }
    return _dataModel;
}
