...
@implementation MKAFBroadcastTxPowerCellModel
@end

@interface MKAFBroadcastTxPowerCell ()
...
@implementation MKAFBroadcastTxPowerCell

+ (MKAFBroadcastTxPowerCell *)initCellWithTableView:(UITableView *)tableView {
    MKAFBroadcastTxPowerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKAFBroadcastTxPowerCellIdenty"];
    if (!cell) {
        cell = [[MKAFBroadcastTxPowerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKAFBroadcastTxPowerCellIdenty"];
    }
    return cell;
}
...
- (void)txPowerSliderValueChanged {
    ...
    if ([self.delegate respondsToSelector:@selector(af_txPowerValueChanged:)]) {
        [self.delegate af_txPowerValueChanged:(NSInteger)self.slider.value];
    }
}
...
#pragma mark - setter
- (void)setDataModel:(MKAFBroadcastTxPowerCellModel *)dataModel {
    _dataModel = nil;
