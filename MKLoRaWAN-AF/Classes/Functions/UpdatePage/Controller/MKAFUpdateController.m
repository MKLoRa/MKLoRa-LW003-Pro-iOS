...
@interface MKAFUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKAFDFUModule *dfuModule;
...
@implementation MKAFUpdateController

- (void)dealloc {
    NSLog(@"MKAFUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_af_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKAFCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_af_centralDeallocNotification" object:nil];
...
- (MKAFDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKAFDFUModule alloc] init];
    }
    return _dfuModule;
}
