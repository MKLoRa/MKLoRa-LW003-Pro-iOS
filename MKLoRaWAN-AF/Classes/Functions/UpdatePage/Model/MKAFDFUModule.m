...
@interface MKAFDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKAFDFUModule

- (void)dealloc{
    NSLog(@"MKAFDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKAFCentralManager shared].peripheral];
}
