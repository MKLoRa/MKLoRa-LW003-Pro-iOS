...
@implementation MKAFPCBAStatusCellModel
@end

@interface MKAFPCBAStatusCell ()
...
@implementation MKAFPCBAStatusCell

+ (MKAFPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKAFPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKAFPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKAFPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKAFPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKAFPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKAFPCBAStatusCellModel.class]) {
        return;
    }
