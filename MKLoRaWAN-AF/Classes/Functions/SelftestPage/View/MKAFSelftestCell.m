...
@implementation MKAFSelftestCellModel
@end

@interface MKAFSelftestCell ()
...
@implementation MKAFSelftestCell

+ (MKAFSelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKAFSelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKAFSelftestCellIdenty"];
    if (!cell) {
        cell = [[MKAFSelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKAFSelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKAFSelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKAFSelftestCellModel.class]) {
        return;
    }
