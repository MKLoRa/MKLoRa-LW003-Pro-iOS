...
@implementation MKAFAboutController

- (void)dealloc {
    NSLog(@"MKAFAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-AF", @"MKAFAboutController", @"af_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-AF", @"MKAFAboutController", @"af_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
