//
//  MKAFPeriodicImmediatelyModel.m
...
@interface MKAFPeriodicImmediatelyModel ()
...
@implementation MKAFPeriodicImmediatelyModel
...
- (BOOL)readPeriodicScanImmediatelyReport {
    ...
    [MKAFInterface af_readPeriodicScanImmediatelyReportParamsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPeriodicScanImmediatelyReport {
    __block BOOL success = NO;
    [MKAFInterface af_configPeriodicScanImmediatelyReportDuration:[self.duration integerValue] interval:[self.interval integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
