...
@implementation MKAFMsgIconButton
...
@interface MKAFSynTableHeaderView ()
...
@property (nonatomic, strong)MKAFMsgIconButton *synButton;

@property (nonatomic, strong)MKAFMsgIconButton *emptyButton;

@property (nonatomic, strong)MKAFMsgIconButton *exportButton;
...
@implementation MKAFSynTableHeaderView
...
- (MKAFMsgIconButton *)synButton {
    if (!_synButton) {
        _synButton = [[MKAFMsgIconButton alloc] init];
        _synButton.topIcon.image = LOADICON(@"MKLoRaWAN-AF", @"MKAFSynTableHeaderView", @"af_sync_enableIcon.png");
        _synButton.msgLabel.text = @"Sync";
    }
    return _synButton;
}

- (MKAFMsgIconButton *)emptyButton {
    if (!_emptyButton) {
        _emptyButton = [[MKAFMsgIconButton alloc] init];
        _emptyButton.topIcon.image = LOADICON(@"MKLoRaWAN-AF", @"MKAFSynTableHeaderView", @"af_delete_enableIcon.png");
        _emptyButton.msgLabel.text = @"Empty";
    }
    return _emptyButton;
}

- (MKAFMsgIconButton *)exportButton {
    if (!_exportButton) {
        _exportButton = [[MKAFMsgIconButton alloc] init];
        _exportButton.topIcon.image = LOADICON(@"MKLoRaWAN-AF", @"MKAFSynTableHeaderView", @"af_export_enableIcon.png");
