...
@interface MKAFFilterByPirModel ()
...
@implementation MKAFFilterByPirModel
...
- (BOOL)readFilterStatus {
    ...
    [MKAFInterface af_readFilterByPirStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterStatus {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByPirStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDelayStatus {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByPirDelayResponseStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDelayStatus {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByPirDelayResponseStatus:self.delayStatus sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSensorSensitivity {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByPirSensorSensitivityWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSensorSensitivity {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByPirSensorSensitivity:self.sensitivity sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDetection {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByPirDetectionStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDetection {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByPirDetectionStatus:self.detection sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPirDoorStatus {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByPirDoorStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPirDoorStatus {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByPirDoorStatus:self.doorStatus sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readFilterMajor {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByPirMajorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterMajor {
    ...
    [MKAFInterface af_configFilterByPirMajorMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readFilterMinor {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByPirMinorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        NSInteger min = [returnData[@"result"][@"minValue"] integerValue];
        NSInteger max = [returnData[@"result"][@"maxValue"] integerValue];
...
- (BOOL)configFilterMinor {
    ...
    [MKAFInterface af_configFilterByPirMinorMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
