...
@interface MKAFFilterByBeaconModel ()
...
@implementation MKAFFilterByBeaconModel
...
- (BOOL)readBeaconFilterStatus {
    ...
    [MKAFInterface af_readFilterByBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterStatus {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByBeaconStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterMajor {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByBeaconMajorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterMajor {
    ...
    [MKAFInterface af_configFilterByBeaconMajorWithMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterMinor {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByBeaconMinorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterMinor {
    ...
    [MKAFInterface af_configFilterByBeaconMinorWithMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterUUID {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterUUID {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterStatus {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByBXPBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.isOn = [returnData[@"result"][@"isOn"] boolValue];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)configBXPBeaconFilterStatus {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByBXPBeaconStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterMajor {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByBXPBeaconMajorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.minMajor = returnData[@"result"][@"minValue"];
        self.maxMajor = returnData[@"result"][@"maxValue"];
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configBXPBeaconFilterMajor {
    ...
    [MKAFInterface af_configFilterByBXPBeaconMajorWithMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterMinor {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByBXPBeaconMinorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.minMinor = returnData[@"result"][@"minValue"];
        self.maxMinor = returnData[@"result"][@"maxValue"];
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configBXPBeaconFilterMinor {
    ...
    [MKAFInterface af_configFilterByBXPBeaconMinorWithMinValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterUUID {
    __block BOOL success = NO;
    [MKAFInterface af_readFilterByBXPBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.uuid = returnData[@"result"][@"uuid"];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)configBXPBeaconFilterUUID {
    __block BOOL success = NO;
    [MKAFInterface af_configFilterByBXPBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
