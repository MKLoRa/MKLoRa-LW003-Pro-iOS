...
@interface MKAFFilterRawAdvDataModel : MKFilterRawAdvDataModel<mk_af_BLEFilterRawDataProtocol>
- (void)updateWithModel:(MKFilterRawAdvDataModel *)model;
@end

@interface MKAFFilterByOtherModel : NSObject<MKFilterByOtherProtocol>
