...
@interface MKAFFilterByRawDataModel ()
...
@implementation MKAFFilterByRawDataModel
...
- (BOOL)readFilterByRawDataStatus {
    ...
    [MKAFInterface af_readFilterTypeStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
