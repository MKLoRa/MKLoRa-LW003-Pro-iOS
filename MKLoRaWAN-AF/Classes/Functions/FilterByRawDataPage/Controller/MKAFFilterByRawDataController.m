//
//  MKAFFilterByRawDataController.m
...
@interface MKAFFilterByRawDataController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAFFilterByRawDataModel *dataModel;

@end

@implementation MKAFFilterByRawDataController

- (void)dealloc {
    NSLog(@"MKAFFilterByRawDataController销毁");
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        MKAFFilterByBeaconModel *model = [[MKAFFilterByBeaconModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 1) {
        ...
        MKAFFilterByUIDModel *model = [[MKAFFilterByUIDModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 2) {
        ...
        MKAFFilterByURLModel *model = [[MKAFFilterByURLModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 3) {
        ...
        MKAFFilterByTLMModel *model = [[MKAFFilterByTLMModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 0) {
        ...
        MKAFFilterByBXPButtonModel *model = [[MKAFFilterByBXPButtonModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 1) {
        ...
        MKAFFilterByBXPTagModel *model = [[MKAFFilterByBXPTagModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 2) {
        ...
        MKAFFilterByPirModel *model = [[MKAFFilterByPirModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 3) {
        ...
        MKAFFilterByTofModel *model = [[MKAFFilterByTofModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 4) {
        ...
        MKAFFilterByOtherModel *model = [[MKAFFilterByOtherModel alloc] init];
...
- (void)configDeviceInfo:(BOOL)isOn {
    ...
    [MKAFInterface af_configFilterByBXPDeviceInfoStatus:isOn sucBlock:^{
        [[MKHudManager share] hide];
...
- (void)configBXPAcc:(BOOL)isOn {
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKAFInterface af_configBXPAccFilterStatus:isOn sucBlock:^{
        [[MKHudManager share] hide];
...
- (void)configBXPTH:(BOOL)isOn {
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKAFInterface af_configBXPTHFilterStatus:isOn sucBlock:^{
        [[MKHudManager share] hide];
...
- (MKAFFilterByRawDataModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAFFilterByRawDataModel alloc] init];
    }
    return _dataModel;
}
