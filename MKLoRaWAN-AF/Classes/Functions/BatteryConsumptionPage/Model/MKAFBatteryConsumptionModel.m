...
@interface MKAFBatteryConsumptionModel ()
...
@implementation MKAFBatteryConsumptionModel
...
- (BOOL)readCurrent {
    ...
    [MKAFInterface af_readBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readLast {
    __block BOOL success = NO;
    [MKAFInterface af_readLastCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readAll {
    __block BOOL success = NO;
    [MKAFInterface af_readAllCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
