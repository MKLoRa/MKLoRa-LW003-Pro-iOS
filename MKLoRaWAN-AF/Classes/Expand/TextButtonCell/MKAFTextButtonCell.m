...
@implementation MKAFTextButtonCellModel
@end

@interface MKAFTextButtonCell ()
...
@implementation MKAFTextButtonCell

+ (MKAFTextButtonCell *)initCellWithTableView:(UITableView *)tableView {
    MKAFTextButtonCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKAFTextButtonCellIdenty"];
    if (!cell) {
        cell = [[MKAFTextButtonCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKAFTextButtonCellIdenty"];
    }
    return cell;
}
...
- (void)rightButtonPressed {
    if ([self.delegate respondsToSelector:@selector(af_textButtonCell_buttonAction:)]) {
        [self.delegate af_textButtonCell_buttonAction:self.dataModel.index];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKAFTextButtonCellModel *)dataModel {
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKAFTextButtonCellModel.class]) {
        return;
    }
